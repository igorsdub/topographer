...
def test_sort_nodes_ascending_orders_by_scalar():
    """Ensure ascending sort returns nodes in increasing scalar order."""
...
def test_sort_nodes_descending_orders_by_scalar():
    """Ensure descending sort returns nodes in decreasing scalar order."""
    graph = easy_path_graph(5)
...
def test_check_scalar_uniqueness_matches_graph_data():
    """Verify scalar uniqueness helper matches valid and invalid fixtures."""
